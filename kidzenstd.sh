...
figlet Kidzen STD | lolcat

echo -e  "_____________________________________________________________"
echo -e  "Tools    : Kidzen STD $white         " |lolcat
echo -e  "Created  : Dimas Aditya $white   " |lolcat
echo -e  "Contact  : kidzenstd@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Dimas Aditya" | lolcat
exit
;;
